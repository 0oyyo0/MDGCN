...
load('./data/IP_correct_gyh');
load('./data/IP_correct_gt');
[ ~, ~, ~, ~, trpos,tepos ] = TrainTestPixel(indian_pines_corrected, indian_pines_gt, train_num, 15 );

save('./data/trpos', 'trpos');
save('./data/tepos', 'tepos');
% You may need to add the path of python manually
system('python trainGCN.py');
